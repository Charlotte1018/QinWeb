                    ...
                    <div style={{ textAlign: 'center' }}>
                        ...
                        <div style={{ display: 'flex', justifyContent: 'center',marginTop: '30px', }}>
                            <div className={styles.card} style={{ marginRight: '40px' }}>
                                <img width='100px' height='100px' style={{ marginTop: '50px' }} src='http://osrfoudqr.bkt.clouddn.com/test/bind.svg' ></img>
                                <div>
                            ...
                            <div className={styles.card}>
                                <img width='100px' height='100px' style={{ marginTop: '50px' }} ></img>
                                <div>
                                    <Button size="large" type="primary" ghost style={{ marginTop: '30px', height: '35px' }}>
                                        我没有CA证书
                                    </Button>
