            ...
            <Page {...pageProps}>
                {/* <div className={styles.certificateRequest}>
                    <div style={{ textAlign: 'center' }}>
                        ...
                        <Button size="large" type="primary" style={{ marginTop: '40px', width: '200px' }}>
                            下一步
                        </Button>
                    </div>
                </div> */}
                    ...
                    <div className={styles.card} >
                        <div style={{ textAlign: 'center' }}>
                            <div className={styles.title}>
                                ...
                                <h1 style={{ marginTop: '10px', color: '#8E8E8E' }} className={styles.f14}>(请使用有NFC功能的安卓手机并下载APP进行认证)</h1>
                            </div>
                    ...
                    <div className={styles.card} style={{ marginLeft: '30px' }}>
                        <div style={{ textAlign: 'center' }}>
                            <div >
                                ...
                                <h1 style={{ marginTop: '10px', color: '#8E8E8E' }} className={styles.f14}>(请使用eID专用读卡器进行认证进行认证)</h1>
                            </div>
                            <div style={{ marginTop: '40px' }}>
                                <img src={pcH} style={{width:'150px',height:'190px'}}></img>
                            </div>
                            <div style={{ marginTop: '50px' }}>
                                <Button size="large" type="primary" ghost style={{ marginTop: '40px', width: '200px' }}>
                                    开始认证
                                </Button>
                            </div>
